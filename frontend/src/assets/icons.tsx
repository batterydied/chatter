...
export const EditIcon = ({iconColor='#000000', className, onClick}: iconProps) => {
    return (
...
export const ReplyIcon = ({iconColor='#000000', className, onClick}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color={iconColor} fill="none">
...
export const DeleteIcon = ({iconColor='#000000', className, onClick}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color={iconColor} fill="none">
...
export const RemoveUserIcon = ({iconColor='#000000', className, onClick}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color={iconColor} fill="none">
...
export const UserIcon = ({iconColor='#000000', className, onClick}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color={iconColor} fill="none">
...
export const RequestIcon = ({iconColor='#000000', className, onClick}: iconProps) => {
    return (
       <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color={iconColor} fill="none">
...
export const CheckIcon = ({iconColor='#000000', className, onClick}: iconProps) => {
    return (
       <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color={iconColor} fill="none">
...
export const XIcon = ({iconColor='#000000', className, onClick}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color={iconColor} fill="none">
