...
export const EditIcon = ({iconColor='#000000', className, onClick, size=24}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={iconColor} fill="none">
...
export const SmileIcon = ({iconColor='#000000', className, onClick, size=24}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={iconColor} fill="none">
...
export const ReplyIcon = ({iconColor='#000000', className, onClick, size=24}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={iconColor} fill="none">
...
export const DeleteIcon = ({iconColor='#000000', className, onClick, size=24}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={iconColor} fill="none">
...
export const RemoveUserIcon = ({iconColor='#000000', className, onClick, size=24}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={iconColor} fill="none">
...
export const UserIcon = ({iconColor='#000000', className, onClick, size=24}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={iconColor} fill="none">
...
export const RequestIcon = ({iconColor='#000000', className, onClick, size=24}: iconProps) => {
    return (
       <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={iconColor} fill="none">
...
export const CheckIcon = ({iconColor='#000000', className, onClick, size=24}: iconProps) => {
    return (
       <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={iconColor} fill="none">
...
export const XIcon = ({iconColor='#000000', className, onClick, size=24}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={iconColor} fill="none">
...
export const GearsIcon = ({iconColor='#000000', className, onClick, size=24}: iconProps) => {
    return (
        <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={size} height={size} color={iconColor} fill="none">
